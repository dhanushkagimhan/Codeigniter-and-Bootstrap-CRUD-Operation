        ...
        <div class="container m-3">
            ...
            <form method="post" name="userinput">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="uname" placeholder="Enter studnet name" name="name" required>
                </div>

                <div class="form-group">
                    <label for="uemail"> Student Email: </label>
                    <input type="text" class="form-control" id="uemail" placeholder="Enter studnet email" name="email" required>
                </div>

                <div class="form-group">
                    <label for="upnum"> Student Phone Number: </label>
                    <input type="text" class="form-control" id="upnum" placeholder="Enter studnet phone number" name="pnum" required>
                </div>
